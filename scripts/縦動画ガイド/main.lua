...
local function draw_circles_at(radius, positions)
  local polygons = {}
...
obj.load("figure", "円", 0xffffff, layout.screen_radius * 2)
draw_circles_at(layout.screen_radius, {
  { -layout.width / 2 + layout.screen_radius, -layout.height / 2 + layout.screen_radius },
  { layout.width / 2 - layout.screen_radius, -layout.height / 2 + layout.screen_radius },
  { -layout.width / 2 + layout.screen_radius, layout.height / 2 - layout.screen_radius },
  { layout.width / 2 - layout.screen_radius, layout.height / 2 - layout.screen_radius },
})
...
for _, rect in ipairs(rects) do
  if rect.radius > 0 then
    ...
    draw_circles_at(rect.radius, {
      { rect.x + rect.radius - layout.width / 2, rect.y + rect.radius - layout.height / 2 },
      { rect.x + rect.width - rect.radius - layout.width / 2, rect.y + rect.radius - layout.height / 2 },
      { rect.x + rect.radius - layout.width / 2, rect.y + rect.height - rect.radius - layout.height / 2 },
      {
